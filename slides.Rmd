...
### 05: Einführung und Begrüßung zum 2. Teil der VL

```{r}
knitr::include_url("slides/intro_projektkurs_data-science2.html")
```

### 06: Wahrscheinlichkeiten, Verteilungen und Konfidenzintervalle

```{r}
knitr::include_url("slides/probability-and-confidence-interval.html")
```

### 07: Inferenzstatistik (Hypothestest)

```{r}
knitr::include_url("slides/inference.html")
```

### 08: Lineare Regression (inkl. Interaktionsterme)
...
### 09: Dritter Teil der Case-Study 

```{r}
knitr::include_url("slides/VL_case-study-Teil3.html")
```

### 10: Kausalität in den Wirtschaftswissenschaften
...
### 12: Instrumentalvariablenschätzung
...
- Zur Instrumentalvariablenschätzung in R verwenden wir das _AER_: Kleiber, Christian, and Achim Zeileis. 2026. AER: Applied Econometrics with R (version 1.2-16). https://CRAN.R-project.org/package=AER.
...
### 13: Einführung in das maschinelle Lernen
