...
- Die Erinnerung an die Sparmöglichkeit hat in Wirklichkeit keinen Einfluss auf das Kaufverhalten. Die Stichprobe zeigt zufällig einen Unterschied, wir verwerfen $H_0$ und schließen fälschlich auf eine Wirkung.
...
- Die Erinnerung der Studierenden an die Sparmöglichkeit senkt tatsächlich die Kaufwahrscheinlichkeit, der Test wird aber nicht signifikant. Wir behalten $H_0$ bei und übersehen den vorhandenen Effekt.
